    ...
    <div className="row">
      ...
      <div className="about__content">
        <div className="about__text generic-text">
          ...
          <p>I also have a <a className="about__link" rel="noopener noreferrer" href="https://www.youtube.com/channel/UCBV-JvG9Ubkj7AU6Cxls1Tw?view_as=subscriber" target="_blank">YouTube channel</a> dedicated to teaching web development. In January 2018, I created my first ever React tutorial. Since then, I've taught JavaScript, React, Node and Express to thousands of people through my tutorials.</p>
        </div>
      </div>
    </div>
  </section>
